<?php $__env->startSection('title'); ?> Contact Us | Imperial Estate <?php $__env->stopSection(); ?>

<?php $__env->startSection('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('public/assets/css/unit-test.css')); ?>">
<style type="text/css">
.arrow-right {
					...
					<div class="vc_column-inner vc_custom_1488483852815">
						<div class="prague-formidable  vc_formidable">
							<div class="frm_forms  with_frm_style frm_style_formidable-style-2-2" id="frm_form_3_container">
								<form action="<?php echo e(route('contact-us.post')); ?>" enctype="multipart/form-data" method="post" class="frm-show-form contact-us-form" id="">
									<?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('public/assets/js/gmap.min.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\imperial\resources\views/contactus/index.blade.php ENDPATH**/ ?>