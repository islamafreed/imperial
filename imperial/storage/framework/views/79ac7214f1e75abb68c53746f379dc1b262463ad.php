<?php $__env->startSection('title'); ?> Package Request | Imperial Estate <?php $__env->stopSection(); ?>
		...
		<div class=" col-sm-12 no-padd">
			<div class="container-fluid top-banner no-padd  simple  dark  dark no-marg-bottom vindow-height">
				<div class="content">
					...
					<div class="subtitle"><?php echo e(ucwords($package->name)); ?></div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form action="<?php echo e(route('packages.post')); ?>" method="post">
					<?php echo csrf_field(); ?>
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 mb_10">
							<input type="text" id="package" class="form-control" placeholder="Package" value="<?php echo e(ucwords($package->name)); ?>"  readonly />
						</div>
						<div class="col-md-6 col-sm-6 mb_10">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\imperial\resources\views/package/show.blade.php ENDPATH**/ ?>