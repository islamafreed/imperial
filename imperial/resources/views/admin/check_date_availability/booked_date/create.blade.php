...
@section('title') Add Booked Date @endsection
		...
		<div class="card">
			<div class="header">
				...
				<ul class="header-dropdown m-r--5">
					...
					<li><a href="{{ route('admin.check-date-availability') }}" class="btn btn-success">View all Request</a></li>
                    <li><a href="{{ route('admin.booked-date') }}" class="btn btn-warning">View all booked dates</a></li>
					
				</ul>
			</div>
			<div class="body">
				<form id="form_validation" method="POST" action="{{ route('admin.add-booked-date.post') }}">
					{{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="phone_no" value="{{ old('phone_no') }}" autocomplete="off" maxlength="10" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-float">
                                <div class="form-line datep">
                                    <input type="text" class="form-control datepicker" name="booked_date" value="{{ old('booked_date') }}" autocomplete="off" required>
