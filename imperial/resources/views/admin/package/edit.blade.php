...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form id="form_validation" method="POST" action="{{ route('admin.update-package',Crypt::encrypt($package->id)) }}" enctype="multipart/form-data">
					@csrf
                    @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="name" value="{{ old('name',$package->name) }}" autocomplete="off" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="package_price" value="{{ old('package_price',$package->package_price) }}" autocomplete="off" maxlength="10" onkeyup="this.value=this.value.replace(/[^0-9 -]/g,'')" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <input name="tags" id="tags" value="@if(isset($tags)){{ old('tags',implode(', ', $tags)) }} @endif" data-role="tagsinput" type="text" class="form-control filter-input" placeholder="Enter the package points" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="remarks" class="form-control tinymce">{{ old('remarks',$package->remarks) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="package_img" class="dropify" data-height="100" {{ old('package_img') }} data-default-file="@if(isset($package->package_img)){{ url('public/uploads/package/'.$package->package_img) }}@endif">
                            </div>
                        </div>
                    </div>
