	...
	<div class="col-xs-12 no-padd">
		<div class="owl-carousel owl-theme hero" id="hero">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-7">
						<img src="{{ asset('public/assets/img/banner_logo1.png') }}" class="banner_logo" alt="Banner Logo">
					...
					<div class="col-md-5 detail-parallax-text-item">
						<div class="detail-parallax-item-right ">
							...
							<div class="row">
								<div class="col-md-12">
									<form action="{{ route('lead.post') }}" enctype="multipart/form-data" method="post">
										@csrf
			...
			<div class="container-fluid top-banner hero_banner big  light item">
			<img src="{{ asset('public/assets/img/banner_10-min.jpg') }}" class="s-img-switch"  alt="top-banner image" />
			<div class="content">
				<div class="row">
					<div class="col-md-7">
						<img src="{{ asset('public/assets/img/banner_logo1.png') }}" class="banner_logo" alt="Banner Logo">
					...
					<div class="counter-outer" style="padding:10px;">
	                      <video width="450" controls crossorigin playsinline
				            poster="{{ asset('public/assets/img/thumbnail.jpeg') }}">
				           		<source src="{{ asset('public/assets/img/Teaser.mp4') }}" type="video/mp4"/>
				          </video>
				    </div>
				</div>
			</div>
	...
	<div id="g_imgs" class="owl-carousel owl-theme">
        ...
        <div class="item ">
            <div class="showcase fit-image popup">
                <a href="{{ url('public/uploads/gallery_img/'.$g_img->g_img) }}"><img src="{{ url('public/uploads/gallery_img/'.$g_img->g_img) }}" alt="" class="img-responsive"></a>
            </div>
        </div>
        @endforeach
		@endforeach
