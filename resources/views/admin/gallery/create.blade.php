...
@section('title') Add Gallery Image @endsection
...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="body">
				<form id="form_validation" method="POST" action="{{ route('admin.add-gallery-img.post') }}" enctype="multipart/form-data">
					{{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="caption" value="{{ old('caption') }}" autocomplete="off" required>
						   ...
						   <label for="gallery_cat_id">Gallery Category</label> 
							...
							<select class="form-control" name="gallery_cat_id" id="gallery_cat_id" required>
                                ...
                                @foreach($gallery_cats as $gallery_cat)
			                    	<option value="{{ $gallery_cat->id }}" data-themeid="{{ $gallery_cat->id }}" {{ old('gallery_cat_id') == $gallery_cat->id ? 'selected' : '' }}>{{ ucwords($gallery_cat->name) }}</option>
			                    @endforeach
                            </select>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {{-- <input type="file" name="gallery_img" class="dropify" data-height="100" {{ old('gallery_img') }} required> --}}
                                <div id="photo"></div>
...
<script>
	...
	$('#filer_input').filer({
        ...
        uploadFile: {
            ...
            url: '{{ route("admin.gallery.image.ajax") }}', //URL to which the request is sent {String}
            data: {
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            ...
            $.post('{{ route('admin.gallery.image.delete.ajax') }}', {file: file_name});
        },
        onEmpty: null,
        options: null,
        dialogs: {
